defmodule Malachi.TCPAcceptorPoolTest do
  ...
  describe "start_link/1" do
    test "fails with invalid port" do
      result = Malachi.TCPAcceptorPool.start_link(99_999_999)
    ...
    test "fails when port is already in use" do
      ...
      result = Malachi.TCPAcceptorPool.start_link(port)
  ...
  describe "configuration" do
    test "accepts valid port numbers" do
      ...
      assert is_integer(Application.get_env(:malachi, :tcp_port, 4040))
    end
  ...
  describe "supervisor behavior" do
    ...
    test "has child acceptors running" do
      case Supervisor.which_children(Malachi.TCPAcceptorPool) do
  ...
  describe "error handling" do
    test "handles invalid port gracefully" do
      # Port 0 is invalid
      result = Malachi.TCPAcceptorPool.start_link(0)
    ...
    test "handles negative port" do
      result = Malachi.TCPAcceptorPool.start_link(-1)
      assert {:error, _} = result
    end
  end
end
