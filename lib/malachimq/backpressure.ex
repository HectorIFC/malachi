defmodule MalachiMQ.Backpressure do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> MalachiMQ.Backpressure.get_queue_pressure("orders")
      {:ok, %{pressure: 0.85, status: :high_pressure, buffer_size: 8500, max_size: 10000}}
      
      iex> MalachiMQ.Backpressure.should_apply_backpressure?("orders")
      true
  """
  ...
  def get_queue_pressure(queue_name) do
    ...
    if MalachiMQ.QueueConfig.queue_exists?(queue_name) do
