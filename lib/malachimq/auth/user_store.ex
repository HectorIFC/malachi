defmodule MalachiMQ.Auth.UserStore do
  @moduledoc """
  ...
  The ETS table `:malachimq_users` is used as an in-memory read cache,
  ...
  @mnesia_table :malachimq_mnesia_users
  ...
  defp setup_mnesia do
    node = node()
    mnesia_dir = Application.get_env(:malachimq, :mnesia_dir)
    ...
    storage_type =
      if Application.get_env(:malachimq, :mnesia_ram_only, false) do
        :ram_copies
      else
        :disc_copies
      end
