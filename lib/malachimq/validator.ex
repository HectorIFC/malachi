defmodule MalachiMQ.Validator do
  @moduledoc """
  Input validation and sanitization for MalachiMQ.
  ...
  @cache_table :malachimq_validated_names
  @throttle_table :malachimq_validation_logs
  ...
  ## Examples
      ...
      iex> MalachiMQ.Validator.validate_queue_name("orders")
      :ok
      
      iex> MalachiMQ.Validator.validate_queue_name("my queue")
      {:error, :invalid_queue_name_invalid_characters}
      
      iex> MalachiMQ.Validator.validate_queue_name("system")
  ...
  ## Examples
      ...
      iex> MalachiMQ.Validator.validate_message_size("hello", 1000)
      :ok
      
      iex> payload = :crypto.strong_rand_bytes(2000)
      iex> MalachiMQ.Validator.validate_message_size(payload, 1000)
  ...
  ## Examples
      ...
      iex> MalachiMQ.Validator.validate_payload("small", 10_485_760)
      :ok
      
      iex> payload = :crypto.strong_rand_bytes(11_000_000)
      iex> MalachiMQ.Validator.validate_payload(payload, 10_485_760)
  ...
  ## Examples
      ...
      iex> MalachiMQ.Validator.validate_headers(%{"priority" => 1})
      :ok
      
      iex> MalachiMQ.Validator.validate_headers(%{"nested" => %{"x" => 1}})
  ...
  ## Examples
      ...
      iex> MalachiMQ.Validator.sanitize_for_html("<script>alert(1)</script>")
  ...
  ## Examples
      ...
      iex> MalachiMQ.Validator.sanitize_for_log("text\\r\\ninjected")
      "text  injected"
  """
  ...
  defp increment_cache_hit do
    MalachiMQ.Metrics.increment_validation_cache_hit()
  rescue
  ...
  defp increment_cache_miss do
    MalachiMQ.Metrics.increment_validation_cache_miss()
  rescue
    _ -> :ok
  end
  ...
  defp log_validation_error({:error, reason}, context) do
    ...
    if should_log do
      ...
      try do
        ...
        MalachiMQ.Metrics.increment_validation_error(category)
      rescue
        _ -> :ok
      end
    end
