defmodule MalachiMQ.MemoryMonitor do
  @moduledoc """
  ...
  @impl true
  def init(_opts) do
    check_interval = Application.get_env(:malachimq, :memory_check_interval_ms, 30_000)
    gc_threshold_mb = Application.get_env(:malachimq, :gc_threshold_mb, 500)
    auto_gc = Application.get_env(:malachimq, :auto_gc_enabled, true)
