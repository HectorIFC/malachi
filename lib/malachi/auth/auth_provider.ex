defmodule Malachi.Auth.AuthProvider do
  @moduledoc """
  The contract every authentication mechanism implements: the plug point for **external** auth.
  ...
  internal, sourced from the replicated user store. This mirrors how Kafka/Pulsar separate a pluggable
