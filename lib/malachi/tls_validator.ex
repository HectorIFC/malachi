defmodule Malachi.TLSValidator do
  @moduledoc """
  ...
  def validate!(env) do
    ...
    require_tls = Application.get_env(:malachi, :require_tls, false)
  ...
  defp validate_tls_config!(env) do
    cert_file = Application.get_env(:malachi, :tls_certfile)
    key_file = Application.get_env(:malachi, :tls_keyfile)
