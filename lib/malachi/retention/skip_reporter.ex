defmodule Malachi.Retention.SkipReporter do
  ...
  def init(opts) do
    max =
      ...
      |> Config.checked(:retention_skip_ledger_max, @default_max, &(is_integer(&1) and &1 > 0))
    ...
    window_ms =
      ...
      |> Config.checked(:retention_skip_log_window_ms, @default_window_ms, &(is_integer(&1) and &1 >= 0))
